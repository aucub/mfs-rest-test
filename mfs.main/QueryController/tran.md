...
> URL: http://localhost:8080/query/tran?uid=PushRecord&start=-9h&stop=+1h
>
> Origin Url: http://localhost:8080/query/tran
>
> Type: POST
...
|Required| Parameter | Type | Value | Description |
|---------|---------|------|------|------------|
|false|uid|String|uid_y0yow||
|false|start|String|start_nn46e||
|false|stop|String|stop_9d8a9||
